...
create_kind_cluster() {
    ...
    curl -sSLo kind "https://github.com/kubernetes-sigs/kind/releases/download/$KIND_VERSION/kind-darwin-amd64"
    chmod +x kind
    ...
    docker cp ~/.kube/config ct:.kube/config
